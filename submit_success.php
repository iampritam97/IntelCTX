...
<section class="max-w-2xl mx-auto px-6 py-16 text-center space-y-4">
  <h1 class="text-2xl font-bold text-primary tracking-tight">Thank you for your submission!</h1>
